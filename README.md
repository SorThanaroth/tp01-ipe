https://github.com/SorThanaroth/tp01-ipe
## About TP01 IPE
...
```sh
git config --global user.name sorThanaroth
git config --global user.email sorthanaroth018@gmail.com
```
...
git init
git remote add origin/main https://github.com/SorThanaroth/tp01-ipe
git branch -M main
```
